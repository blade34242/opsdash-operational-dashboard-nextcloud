...
- Sidebar panes live in `opsdash/src/components/sidebar/` (Calendars, Targets, Theme, Profiles, Report, Deck; Summary tab removed in 0.4.7) and share helpers via `sidebar/validation.ts`.
