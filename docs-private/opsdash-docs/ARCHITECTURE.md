...
- Controllers:
  - `Controller/OverviewController.php`: `index`, `load`, `ping` (+ legacy `save` selection endpoint).
  ...
  - `Controller/PresetsController.php`: preset list/save/load/delete at `/overview/presets`
