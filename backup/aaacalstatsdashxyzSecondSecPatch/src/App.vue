<template>
  ...
  <NcAppContent app-name="Calendar Dashboard">
    <template #navigation>
      <NcAppNavigation>
        ...
        <div class="notes-section">
          ...
          <textarea :value="notesPrev" readonly rows="4" class="notes-textarea"></textarea>
          <div class="hint" :title="notesLabelCurrTitle">{{ notesLabelCurr }}</div>
          <textarea v-model="notesCurrDraft" rows="4" class="notes-textarea" placeholder="Write your notes…"></textarea>
    ...
    <div class="app-container">
      ...
      <div class="banner warn" v-if="isTruncated">
      ...
      <div class="card full tab-panel" v-show="pane==='cal'">
        ...
        <template v-else>
          <table>
            <colgroup><col class="col-w-60"><col class="col-w-20"><col class="col-w-20"></colgroup>
            <thead>
              <tr>
          ...
          <div class="grid2 mt-12" v-if="groupList.length">
      ...
      <div class="card full tab-panel" v-show="pane==='top'">
        ...
        <template v-else>
          <table>
            ...
            <tbody>
              <tr v-for="(r,i) in longest" :key="i" @click="toggleDetails(i)" class="cursor-pointer">
                <td>{{ r.calendar }}</td>
