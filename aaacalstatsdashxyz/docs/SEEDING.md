...
- Dashboard API:
  - Week: `BASE/index.php/apps/aaacalstatsdashxyz/config_dashboard/load?range=week&offset=0`
  - Month: `BASE/index.php/apps/aaacalstatsdashxyz/config_dashboard/load?range=month&offset=0`
