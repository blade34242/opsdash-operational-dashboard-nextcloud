...
## 0.3.1 — Remove metrics and admin settings
- Removed usage metrics (global and per-user) and all related admin settings/screens.
- Deleted unsupported `appinfo/database.xml` schema (no custom tables used now).
- Docs updated to reflect metrics removal and current endpoints.
